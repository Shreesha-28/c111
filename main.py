...
#finding the mean for the first data(students who got tablet with learning material)
...
fig.add_trace(go.Scatter(x=[second_std_deviation_end,second_std_deviation_end],y=[0,0.17],mode="lines",name="second standard deviation"))
fig.add_trace(go.Scatter(x=[third_std_deviation_end,third_std_deviation_end],y=[0,0.17],mode="lines",name="third standard deviation"))
fig.show()
...
print("the z score of sample1 is ",z_score1)

z_score2=(mean-mean_of_sample2)/std_deviation
print("the z score of sample2 is ",z_score2)

z_score3=(mean-mean_of_sample3)/std_deviation
print("the z score of sample3 is ",z_score3)